...
export async function addUserUnavailability(userId: string, payload: { starts_on: string; ends_on: string; note: string | null }): Promise<VolunteerUnavailability> { return sendJson<VolunteerUnavailability>(`/api/v1/identity/serving/admin/users/${userId}/unavailability`, "POST", payload); }
export async function updateUserUnavailability(userId: string, id: string, payload: { starts_on: string; ends_on: string; note: string | null }): Promise<VolunteerUnavailability> { return sendJson<VolunteerUnavailability>(`/api/v1/identity/serving/admin/users/${userId}/unavailability/${id}`, "PATCH", payload); }
