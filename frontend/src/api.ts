...
export interface VolunteerPreference { id: string; user_id: string; area: ServingArea; status: VolunteerStatus; preferred_frequency: VolunteerFrequency; frequency_count: number; frequency_period: VolunteerFrequencyPeriod; availability_notes: string | null; admin_notes: string | null; reviewed_at: string | null; }
