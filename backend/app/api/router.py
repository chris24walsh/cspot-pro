...
from app.modules.sunday_school.routes import router as sunday_school_router
...
api_router.include_router(sunday_school_router, prefix="/api/v1/sunday-school", tags=["sunday-school"])
