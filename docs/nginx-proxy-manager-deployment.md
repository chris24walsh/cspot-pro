...
Use the same public host as an authorized redirect origin in Google Cloud. The
backend callback URL will be:

```text
https://cspot.yourdomain.com/api/v1/integrations/google-drive/callback
```
