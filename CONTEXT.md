...
- Worship Live Page mode emphasizes the active lyric page through styling while preserving equal page widths for reliable lyric fitting; its next-page preview is clickable, title cues use a distinct warm highlight, and larger layouts expose a slim previous-page leaf behind the active page.
