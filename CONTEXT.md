...
- Worship Live Scroll mode leaves vertical touch gestures with the full-song lyrics pane; swipe pointer capture is only enabled in Pages mode so Android can scroll the whole song normally.
